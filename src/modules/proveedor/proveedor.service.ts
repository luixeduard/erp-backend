...
import { PatchProveedorDTO, UpdateProveedorDTO } from "./dto/update.dto";
import { Proveedor } from "./entity/proveedor.entity";

@Injectable()
export class ProveedorService extends BaseService<Proveedor, CreateProveedorDTO, UpdateProveedorDTO, PatchProveedorDTO> {
