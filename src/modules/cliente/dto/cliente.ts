...
export class ClienteDTO extends DBRecordDTO {
...
export class ClientePaggingDTO extends PageDTO {
  @ApiProperty({ type: ClienteDTO, isArray: true })
  readonly data: ClienteDTO[]
}