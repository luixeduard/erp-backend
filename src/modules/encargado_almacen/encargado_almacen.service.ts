...
import { UpdateEncargadoAlmacenDTO } from "./dto/update.dto";

@Injectable()
export class EncargadoAlmacenService extends BaseService<EncargadoAlmacen, CreateEncargadoAlmacenDTO, UpdateEncargadoAlmacenDTO> {
